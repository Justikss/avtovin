...
captions = {'backward': '◂ Назад ▸', 'was_selected': 'Вы выбрали', 'cancel': 'Отменить', 'confirm': 'Подтвердить',
            ...
            'send_phone_number': 'Отправить номер'
            }
low_sep = '────────'
__LEXICON = {
    'advert_param_was_deleted': 'Выбранные параметры были удалены администрацией.',
    'develop_moment_notif': 'Ведутся технические работы, повторите попытку позже, когда это сообщение будет автоматически удалено.',
            ...
            'seller_unban': {'message_text': 'Ваш аккаунт продавца успешно разблокирован. Продолжайте совершать продажи с нами!',
                             'buttons': {'close_unblock_notification:seller': 'Скрыть уведомление', 'width': 1}},
...
<b>Тех поддержка:</b>
Контакты доступны с главного меню по кнопке <i>[Поддержка]</i>
''' + '\n<blockquote>Для ознакомления с устройством купле-продажи в боте, выберите кнопки ниже.</blockquote>', 'seller_faq': 'Продажа 👨🏻‍💼', 'buyer_faq': '👨🏻‍💻 Покупка',
...
\n<b>Продажа:</b>\n
<b>После регистрации вы можете:
Оформить тариф чтобы получать отклики:</b>
<blockquote><i>[Меню продавца] - [Профиль] - [Оформить тариф]</i></blockquote>

<b>Создать объявление на авто:</b>
<blockquote><i>[Меню продавца] - [Заявки] - [Создать объявление]</i></blockquote>

<b>Созданные заявки отображаются в:</b>
<blockquote><i>[Меню продавца] - [Заявки] - [Мои объявления]</i></blockquote>

<b>Когда клиент откликается на ваше авто</b>
<i>Вам приходит оповещение в чат с ботом, а так же отклик с контактами покупателя в разделе:</i>
<blockquote><i>[Меню продавца] - [Заявки] - [Отклики]</i></blockquote>

<b>Работа с заявкой.</b>
<b>Удалить сделку которая сорвалась:</b>
<blockquote><i>[Просмотренные отклики] - [Сделка сорвалась]</i></blockquote>

<b>Удалить товар:</b>
<i>В разделе откликов:</i>
<blockquote><i>[Отклики] - [Снять с продажи]</i></blockquote>
<i>В разделе объявлений</i>:
<blockquote><i>[Заявки] - [Мои объявления] - [Снять с продажи]</i></blockquote>

''', 'faq': '◂ Назад ▸', 'return_main_menu': '🏡 В Меню 🏡', 'width': 1},
            'buyer_faq': {'message_text': '''
<b>Покупка:</b>

<b>Вы можете приобрести желаемый автомобиль в нашем телеграмм боте</b>

<b>Совершайте отклики на подходящие вам автомобили.</b>
<i>Поиск машин происходит через цепочку действий с ботом:</i>
<blockquote><i>[Меню покупателя] - [Поиск авто]</i></blockquote>
<i>При поиске автомобилей вы можете указать желаемые параметры авто для получения списка по вашему запросу</i>

<b>Рекомендации авто появляются:</b>
<i>После загрузки продавцом выбранных вами параметров авто</i>
<blockquote><i>[Меню покупателя] - [Предложения] - [Рекомендации]</i></blockquote>
<i>А также основываясь на истории авто, просмотренного ранее.</i>

<b>Объявления, оставшиеся без подтверждения:
Переходят в раздел:</b>
<blockquote><i>[Меню покупателя] - [Предложения] - [Неподтверждённые]</i></blockquote>
<i>Объявления остаются там до момента:
• Отклика с вашей стороны
• По истечению 7-ми дней с первого просмотра.</i>

<b>Ваши отклики отображаются:
С контактами и статусом просмотра отклика от продавца:</b>
<blockquote><i>[Меню покупателя] - [Предложения] - [Подтверждённые]</i></blockquote>
''', 'faq': '◂ Назад ▸', 'return_main_menu': '🏡 В Меню 🏡', 'width': 1},
            ...
            'seller___my_feedbacks': {'message_text': '<b>Отклики</b>', 'buttons': {'new_feedbacks': '✓ Новые ✓', 'viewed_feedbacks': '👁 Изученные 👁', 'backward:seller__my_feedbacks': '◂ Назад ▸', 'width': 2}},
...
───────────────''',
    ...
    'dealership_prefix': '<b>Юридическое лицо</b> 🤵🏻‍♂️',
    'seller_prefix': '<b>Частное лицо</b> 👨🏻‍💼\n',
    'dealership_name_prefix': '<b>Название автосалона:</b> <i>{dealership_name}</i>',
    'dealership_address_prefix': '<b>Адрес автосалона:</b>\n<i>{dealership_address}</i>',
    'seller_name_prefix': '<b>Ваше имя:</b> <i>{seller_name}</i>',
    'phonenumber_prefix': '<b>Номер телефона:</b> {phone_number}',
...
class LexiconSellerProfile(metaclass=SmartGetAttrMeta):
    def __init__(self):
        ...
        self.phonenumber_prefix = f'''<b>{class_lexicon['phonenumber_prefix']}</b>'''
